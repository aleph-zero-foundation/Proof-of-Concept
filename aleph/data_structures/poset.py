...
#===============================================================================================================================
    ...
    def toss_coin(self, U_c, tossing_unit):
        ...
        # print(f'DEBUG; check if shares are valid {len(coin_shares)} ', end='')
        # for process_id in coin_shares.keys():
        #     print(f'{process_id} {self.threshold_coins[fai][0].verify_coin_share(coin_shares[process_id], process_id, level)}', end='')
        # print()
