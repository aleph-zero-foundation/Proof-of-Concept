...
#===============================================================================================================================
    ...
    def add_coin_shares(self, U):
        ...
        for _, dealer_id in indices:
            coin_shares.append((dealer_id, self.threshold_coins[dealer_id][0].create_coin_share(U.level)))
...
#===============================================================================================================================
    ...
    def check_coin_shares(self, U):
        ...
        for (share_id, dealer_id), (cs_dealer_id, coin_share) in zip(indices, U.coin_shares):
            # coin share generated by wrong dealer or cs_dealer_id was wrongly added by a Byzantine process
            if dealer_id != cs_dealer_id:
                return False
...
#===============================================================================================================================
    ...
    def toss_coin(self, U_c, tossing_unit):
        ...
        # we use simple_coin if we don't have
        if fai not in self.threshold_coins or self.has_forking_evidence(tossing_unit, fai):
