...
def sort_and_get_my_pid(public_keys, hosts_ip):
    ...
    return public_keys.index(my_pk), public_keys, hosts_ip
...
async def main():
    ...
    process_id, public_keys, hosts_ip = sort_and_get_my_pid(public_keys, hosts_ip)
